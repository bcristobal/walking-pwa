export class GamificationService {
    private static  API_URL = 'http://20.68.132.115:8000/games/walking-pwa'
    ...
    static fetchMyChallenges = async (token: string) => {
        try {
            ...
            const response = await fetch('http://20.68.132.115:8000/games/walking-pwa/my-challenges', {
                method: 'GET',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'accept': 'application/json'
    ...
    static fetchUserData = async (token: string) => {
        ...
        try {
            const response = await fetch(`http://20.68.132.115:8000/users/me/stats`, {
                method: 'GET',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'accept': 'application/json'
    ...
    static fetchUpdateUser = async (token: string, userData: any) => {
        ...
        try {
            const response = await fetch(`http://20.68.132.115:8000/users/me`, {
                method: 'PUT',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'accept': 'application/json',
